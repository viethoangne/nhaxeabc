    ...
    <main className="mx-auto max-w-4xl px-4 py-6 sm:py-12 relative overflow-visible">
      ...
      >
        ...
        <div className="flex flex-col items-center text-center relative z-10">
          ...
          <motion.h1 
            className="text-2xl sm:text-3xl md:text-4xl font-extrabold bg-gradient-to-r from-rose-600 to-red-700 bg-clip-text text-transparent"
          ...
          <motion.div 
            className="mt-6 sm:mt-8 w-full overflow-hidden rounded-2xl border border-rose-100 bg-gradient-to-br from-rose-50/60 to-red-50/40 p-4 sm:p-6 shadow-sm shadow-rose-50/50 relative"
          ...
          >
            ...
            <div className="flex flex-col items-center gap-3 relative z-10">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-rose-800">{t('sysMsg')}</h3>
              <p className="text-rose-700 leading-relaxed text-xs sm:text-sm md:text-base max-w-xl font-medium">
                {t('sysMsgDesc')}
              </p>
            </div>
          </motion.div>
        ...
        <div className="mt-6 sm:mt-8 grid gap-4 md:grid-cols-2 relative z-10">
          ...
          >
            ...
            <div className="mt-3 flex items-center gap-2.5">
              ...
              <span className="text-xl sm:text-2xl font-black bg-gradient-to-r from-rose-600 to-red-500 bg-clip-text text-transparent">
                {t('failed')}
              </span>
            </div>
          </motion.div>
        ...
        <motion.div 
          className="mt-6 sm:mt-8 rounded-2xl border border-rose-100 bg-rose-50/20 p-4 sm:p-6 relative overflow-hidden"
